      ...
      <View style={{marginTop: useHeaderHeight() + useHeaderHeight() / 8}}>
        ...
        <View style={styles.list}>
          <Text
            ...
            imperdiet. Lectus urna duis convallis convallis tellus id interdum.
            Augue neque gravida in fermentum et sollicitudin ac. Sagittis purus
            sit amet volutpat consequat mauris nunc congue. Urna cursus eget
            nunc scelerisque viverra mauris. Adipiscing vitae proin sagittis
            nisl rhoncus mattis rhoncus urna neque. A scelerisque purus semper
            eget duis. Netus et malesuada fames ac. Mi sit amet mauris commodo
            quis imperdiet massa. Amet consectetur adipiscing elit ut aliquam
            purus sit
          </Text>
        </View>
      </View>
